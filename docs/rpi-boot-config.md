...
The following settings are added to `/boot/firmware/config.txt` on the Pi to force 1080p HDMI output even when no display is detected (needed for headless SSH/Rustdesk access):
